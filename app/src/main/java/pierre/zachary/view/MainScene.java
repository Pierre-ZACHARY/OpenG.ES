...
public class MainScene extends Scene {
    ...
    public MainScene(Context context) {
        ...
        imageGO2 = new GameObject(this, "Image rouge");
        imageGO2.transform.positionX = 2; // 0.5 car le transform est au centre du gameobject
        ...
        imageGO2.addComponent(new OnClickBehaviour(imageGO2));
